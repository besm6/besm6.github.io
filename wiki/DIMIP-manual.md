...
<ul>
  * 1 - символ команды МКП (по умолчанию <). </li>
  * 2 - присвоение байту 'А' включает протокол на ацпу. </li>
  * 3 - уровень макровызова. </li>
  * 4 - число параметров в вызове, либо код ответа. </li>
  * 5 - шкала разрешенных событий.
<ul> <li> 8р=1 разрешение события по 21раз. </li>
  <li> 6р=1 разрешение события образования подчиненной задачи. </li>
  <li> 5р=1 разрешение события окончания подчиненной задачи. </li>
