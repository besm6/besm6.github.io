...
БЭСМ-6 имеет одноадресную систему команд с фиксированной длинной машинного слова.
В одном 50-ти разрядном машинном слове содержится две одноадресные команды по 24-бита каждая. 50-й и 49-й разряды слова - контрольные, относящиеся к "левой" и "правой" команде. 50-й и 49-й разряды содержат признак "команды/данные". Если происходит чтение данных из области где находится код программы происходит прерывание "поконтролю данных/команд".
