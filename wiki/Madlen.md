 ...
 * [2. Операторы автокода](#2-операторы-автокода)
 * [3. Идентификаторы](#3-идентификаторы)
 * [4. Мнемокоды](#4-мнемокоды)
 * [5. Полный адрес](#5-полный-адрес)
 * [6. Указатель индекс-регистра](#6-указатель-индекс-регистра)
 * [7. Метки](#7-метки)
 * [8. Константы](#8-константы)
 * [9. Адреса типа «литерал»](#9-адреса-типа-литерал)
 * [10. Описания](#10-описания)
 * [11. Параметрические команды](#11-параметрические-команды)
 * [12. Данные и рассылки](#12-данные-и-рассылки)
 * [13. Комментарии](#13-комментарии)
 * [14. Правила оформления автокодных подпрограмм](#14-правила-оформления-автокодных-подпрограмм)
 * [15. Базирование](#15-базирование)
 * [16. Примеры автокодных подпрограмм](#16-примеры-автокодных-подпрограмм)
 * [17. Стандартный массив](#17-стандартный-массив)
 * [18. Диагностика ошибок](#18-диагностика-ошибок)
 * [19. Управляющие карты, редактирование, сервис](#19-управляющие-карты-редактирование-сервис)
 * [20. Советы и рекомендации](#20-советы-и-рекомендации)
 * [21. Некоторые приемы программирования на автокоде](#21-некоторые-приемы-программирования-на-автокоде)
...
При трансляции алгольных процедур (написанных на Алголе-ГДР), выхода на Madlen не происходит,
...
**_Мнемокод — это определенная последовательность букв, понимаемых в смысле автокода, цифр и знаков + и —._**
...
**_Полным адресом_** называется любая конструкция
...
**_Метка_** обозначается идентификатором и выполняет
...
до полного машинного слова — дополнены нулями **_справа_**.
...
**_Адресами типа «литерал»_** называются адресные
...
**_Описать идентификатор_** — это значит поставить
...
**_внутренними_** адресами данной подпрограммы. Это
 ...
 * L — _массив_ — можно разместить, начиная с произвольной ячейки памяти;
 * P — _страничный_ массив, начальный адрес которого должен быть кратным 1024<sub>10</sub>;
 * S — _секторный_ массив, начинающийся с адреса, кратного 256<sub>10</sub>.

Тип массива указывается одной из следующих букв:

 * P — _собственный_ массив, т. е, массив, недоступный другим подпрограммам;
 * U — _несобственный_ массив;
 * C — _общий_ массив.
...
```
называется **_косвенной_** эквивалентностью. Она приписывает
...
**_Первая_** группа правил касается использования
...
**_Вторая_** группа правил касается способа передачи
...
**_Третья_** группа правил касается выбора наименований
...
на листинге слева от автокодного текста (см. § 17).
В случае базирования транслированная команда
...
указана диагностика):
 ...
 5. при некоторых ошибках в адресе оператора BAS (НЕЯВНООПРЕДЕЛЕННЫЙ ИДЕНТИФИКАТОР BAS).
...
транслятора с автокода на этапе трансляции фортрапных подпрограмм с языка Мадлен на язык загрузки
